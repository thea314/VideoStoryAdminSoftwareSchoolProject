Public Class addEmployee
    ...
    Private Sub btn_aaddnewEmployee_Click(sender As Object, e As EventArgs) Handles btn_aaddnewEmployee.Click
        ...
        If (Me.txt_username.Text = "" Or (Me.txt_username.Text.Length < 5)) Then
        ...
        If (Me.txt_home.Text = "" Or (Me.txt_home.Text.Length < 7)) Then
            MsgBox("Please enter a phone number of length greater than 7.")
            Me.txt_home.Text = ""
            Exit Sub
        End If

        If (Me.txt_cell.Text = "" Or (Me.txt_cell.Text.Length < 7)) Then
            MsgBox("Please enter a cell number of length greater than 7.")
            Me.txt_cell.Text = ""
            Exit Sub
        End If
        ...
        If (Me.txt_home.Text = "" Or (Me.txt_home.Text.Length > 12)) Then
            MsgBox("Please enter a phone number of length less than 12.")
            Me.txt_home.Text = ""
            Exit Sub
        End If

        If (Me.txt_cell.Text = "" Or (Me.txt_cell.Text.Length > 12)) Then
    ...
    Private Sub txt_home_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_home.KeyPress
