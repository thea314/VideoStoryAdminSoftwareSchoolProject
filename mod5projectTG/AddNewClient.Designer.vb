...
Partial Class AddNewClient
    ...
    Private Sub InitializeComponent()
        ...
        'grp_addnewclient
        '
        Me.grp_addnewclient.Controls.Add(Me.date_dob)
        Me.grp_addnewclient.Controls.Add(Me.mtxt_phone)
        Me.grp_addnewclient.Controls.Add(Me.txt_postal)
        Me.grp_addnewclient.Controls.Add(Me.txt_prov)
        Me.grp_addnewclient.Controls.Add(Me.txt_city)
        Me.grp_addnewclient.Controls.Add(Me.txt_address)
        Me.grp_addnewclient.Controls.Add(Me.txt_email)
        Me.grp_addnewclient.Controls.Add(Me.txt_lname)
        Me.grp_addnewclient.Controls.Add(Me.txt_fname)
        Me.grp_addnewclient.Controls.Add(Me.txt_client_no)
        Me.grp_addnewclient.Controls.Add(Me.btn_cancelnewclient)
        Me.grp_addnewclient.Controls.Add(Me.btn_createnewclient)
        Me.grp_addnewclient.Controls.Add(Me.CheckBox_active)
        Me.grp_addnewclient.Controls.Add(Me.lbl_status)
        Me.grp_addnewclient.Controls.Add(Me.lbl_postal)
        Me.grp_addnewclient.Controls.Add(Me.lbl_prov)
        Me.grp_addnewclient.Controls.Add(Me.lbl_city)
        Me.grp_addnewclient.Controls.Add(Me.lbl_address)
        Me.grp_addnewclient.Controls.Add(Me.lbl_dob)
        Me.grp_addnewclient.Controls.Add(Me.lbl_phone)
        Me.grp_addnewclient.Controls.Add(Me.lbl_email)
    ...
    Friend WithEvents grp_addnewclient As GroupBox
